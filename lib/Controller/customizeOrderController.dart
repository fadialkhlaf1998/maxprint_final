...
class CustomizeOrderController extends GetxController {
            ...
            try {
              final Email email = Email(
                body: "Name: "+name+"\n"+
                    ...
                    "Email: " +emaill+"\n"+
                    "Message: " +message,
                subject: "Printing Offers | Customize Order Request",
                recipients: ["order@printingoffers.ae"],
              );
              await FlutterEmailSender.send(email);
              AppWidget.successMsg(context, App_Localization.of(context).translate("request_order_sent"));
              Get.back();
              clearTextfields();
            }
            catch (e) {
